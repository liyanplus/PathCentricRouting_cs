...
namespace PathSelection
{
    ...
    class FindPathExtendEdge
    {
        ...
        private TraceDB TraceDB { get; set; }
        private uint Beta { get; set; }
        ...
        public Path FindPath(uint[] porigin, uint pdestination)
        {
            ...
            RoutingStateEdge firstEdge = new RoutingStateEdge(porigin[0], null);
  
            RoutingStateEdge secondEdge = new RoutingStateEdge(porigin[1], firstEdge);
